...
- June 21, 2025. Enhanced NewOrderModal with mobile-responsive design and partial payment feature - Redesigned form layout for mobile-first approach, added real-time payment calculation, integrated partial payment input with automatic status detection, improved touch targets and spacing for mobile devices, added visual payment summary with color-coded status badges
