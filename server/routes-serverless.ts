...
/**
 * Serverless-compatible route registration
 * Note: This version does not create an HTTP server (handled by Vercel)
 */
export function registerRoutes(app: Express): void {
  ...
  // Serverless: No HTTP server needed - Vercel handles this
  // Routes are registered on the Express app which is exported
}